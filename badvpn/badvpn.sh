...
fun_udp1 () {
    ...
    menu
	    ...
	    inst_udp () {
            ...
            wget https://raw.githubusercontent.com/PhoenixxZ2023/SSHPLUS-UNY/main/badvpn/badvpn-udpgw -o /dev/null
			wget https://raw.githubusercontent.com/PhoenixxZ2023/SSHPLUS-UNY/main/badvpn/antcrashvpn.sh -o /dev/null
