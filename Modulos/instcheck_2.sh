...
rm /bin/unycheck > /dev/null 2>&1
sleep 5
cd /bin || exit
wget https://ssh.pw5g.com.br/unycheck/unycheck > /dev/null 2>&1
wget https://ssh.pw5g.com.br/unycheck/userscheck > /dev/null 2>&1
chmod 777 unycheck > /dev/null 2>&1
...
wget https://ssh.pw5g.com.br/unycheck/checkuser.py > /dev/null 2>&1
...
clear
echo ""
echo -e "\033[1;31m \033[1;33mCOMANDO PRINCIPAL: \033[1;32munycheck\033[0m"
echo ""
